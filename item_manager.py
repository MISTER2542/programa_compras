...
def show_items(self):   # Muestra el estado del inventario de tus propias instancias de artículos en formato de tabla con columnas ["Número", "Nombre del producto", "Cantidad", "Cantidad"].
    ...
    print(tabulate(table_data, headers=["número", "Nombre del producto", "Cantidad de dinero", "cantidad"], tablefmt="grid"))    # Generar resultados en formato de tabla usando el módulo tabular

def _stock(self):   # Devuelve el estado del stock de la instancia del artículo que posee.
